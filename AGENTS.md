# Simple quarterly income/expense ledger for UK sole traders under MTD (`mtd-quarterly-ledger`) — factory product contract

This repository is one product built by the Param Factory. It ships at
`https://mtd-quarterly-ledger.sociobot.in`. Artifact class: `pwa-offline`.
