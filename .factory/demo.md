...
The persistent banner says **Demo — sample data, nothing is saved**. **Reset demo** clears and reseeds only the demo database. **Start for real** goes to `/`, leaving demo records behind.
